 ...
 */
public class GptVerboseTranscriptionService {

    // -- Singleton setup --
    private static GptVerboseTranscriptionService instance;

    private GptVerboseTranscriptionService() {
        // Private constructor to prevent instantiation
    }

    public static GptVerboseTranscriptionService getInstance() {
        if (instance == null) {
            synchronized (GptVerboseTranscriptionService.class) {
                if (instance == null) {
                    instance = new GptVerboseTranscriptionService();
                }
            }
        }
        return instance;
