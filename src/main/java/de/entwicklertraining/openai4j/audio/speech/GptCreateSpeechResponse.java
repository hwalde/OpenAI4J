 ...
 */
public final class GptCreateSpeechResponse extends GptResponse<GptCreateSpeechRequest> {
     ...
     */
    public GptCreateSpeechResponse(String rawResponseBody, GptCreateSpeechRequest request) {
        super(null, request);
     ...
     */
    public GptCreateSpeechResponse(byte[] rawBytes, GptCreateSpeechRequest request) {
        super(null, request);
