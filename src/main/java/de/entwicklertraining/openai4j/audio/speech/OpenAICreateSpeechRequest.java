 ...
 * <p>
 * This endpoint returns raw audio data (binary) rather than JSON. Hence, the {@link OpenAICreateSpeechResponse}
 * will (normally) store the raw audio content as bytes. If there's an error, the response might be JSON.
 *
 * Usage example:
 * <pre>
 *   OpenAICreateSpeechResponse resp = OpenAICreateSpeechRequest.builder()
 ...
 * </pre>
 */
public final class OpenAICreateSpeechRequest extends OpenAIRequest<OpenAICreateSpeechResponse> {
    ...
    @Override
    public OpenAICreateSpeechResponse createResponse(String responseBody) {
        ...
        // server might respond with JSON. We'll let OpenAICreateSpeechResponse
        // handle it.
        return new OpenAICreateSpeechResponse(responseBody, this);
    }
    ...
    @Override
    public OpenAICreateSpeechResponse createResponse(byte[] responseBytes) {
        // TTS endpoint successful call will be raw audio bytes.
        // If the returned bytes happen to be JSON (i.e. an error),
        // OpenAICreateSpeechResponse will parse that.
        return new OpenAICreateSpeechResponse(responseBytes, this);
    }
    ...
    public static final class Builder extends ApiRequestBuilderBase<Builder, OpenAICreateSpeechRequest> {
        ...
        public OpenAICreateSpeechRequest build() {
            return new OpenAICreateSpeechRequest(
                    this,
                    model,
                    input,
                    voice,
        ...
        @Override
        public OpenAICreateSpeechResponse executeWithExponentialBackoff() {
            return client.sendRequestWithExponentialBackoff(build());
        }

        @Override
        public OpenAICreateSpeechResponse execute() {
