 ...
 */
public class GptWebSearchOptions {
    ...
    /**
     * Builder for GptWebSearchOptions.
     */
    public static class Builder {
        ...
        /**
         * Builds the GptWebSearchOptions object.
         *
         * @return GptWebSearchOptions
         */
        public GptWebSearchOptions build() {
            return new GptWebSearchOptions(this);
        }
    }
