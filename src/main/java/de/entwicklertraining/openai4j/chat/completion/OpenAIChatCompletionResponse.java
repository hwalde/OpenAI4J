 ...
 */
public final class OpenAIChatCompletionResponse extends OpenAIResponse<OpenAIChatCompletionRequest> {

    public OpenAIChatCompletionResponse(JSONObject json, OpenAIChatCompletionRequest request) {
        super(json, request);
    }
