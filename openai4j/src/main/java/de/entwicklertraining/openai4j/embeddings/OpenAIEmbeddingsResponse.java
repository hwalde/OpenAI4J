 ...
 */
public final class OpenAIEmbeddingsResponse extends OpenAIResponse<OpenAIEmbeddingsRequest> {
    ...
    public OpenAIEmbeddingsResponse(String rawBody, OpenAIEmbeddingsRequest request) {
