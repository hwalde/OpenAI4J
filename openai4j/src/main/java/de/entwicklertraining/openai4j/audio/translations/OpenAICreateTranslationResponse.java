 ...
 */
public final class OpenAICreateTranslationResponse extends OpenAIResponse<OpenAICreateTranslationRequest> {

    public OpenAICreateTranslationResponse(String rawResponseBody, OpenAICreateTranslationRequest request) {
