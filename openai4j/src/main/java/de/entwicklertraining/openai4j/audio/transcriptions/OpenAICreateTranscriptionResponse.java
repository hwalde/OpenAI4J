 ...
 */
public final class OpenAICreateTranscriptionResponse extends OpenAIResponse<OpenAICreateTranscriptionRequest> {
     ...
     */
    public OpenAICreateTranscriptionResponse(String rawResponseBody,
                                          OpenAICreateTranscriptionRequest request) {
